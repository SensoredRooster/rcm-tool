...
RCMTool uses two production Cloudflare Workers and two separate private R2 buckets.
...
- URL: `https://rcm-tool-support.sensoredrooster-com.workers.dev`
- Health: `https://rcm-tool-support.sensoredrooster-com.workers.dev/health`
- Upload: `https://rcm-tool-support.sensoredrooster-com.workers.dev/upload`
...
- Worker: `rcm-tool-share`
- URL: `https://rcm-tool-share.sensoredrooster-com.workers.dev`
- Health: `https://rcm-tool-share.sensoredrooster-com.workers.dev/health`
