"""Visual system for Gamepad Signal Lab."""
...
QLabel#Brand { color: #132039; font-size: 16pt; font-weight: 750; }
...
QPushButton#Nav { min-height:38px; text-align:left; padding-left:14px; border:0; border-radius:11px; background:transparent; color:#596B82; }
...
QLineEdit, QComboBox, QSpinBox, QDoubleSpinBox, QTextEdit, QPlainTextEdit { min-height:36px; background:#FFFFFF; border:1px solid #C9D5E4; border-radius:11px; padding:3px 10px; }
...
QToolTip { background:#FFFFFF; color:#172238; border:1px solid #AFC0D5; padding:8px; }
"""
